...
### Почему токены дорожают?

- Запросы становятся длиннее: контекст, репо, логи, скриншоты
- Одна задача превращается в несколько агентских прогонов
- Качественный inference становится частью себестоимости разработки
- Оптимизация: не "меньше токенов", а "меньше пустой работы"
