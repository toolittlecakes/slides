...
#### Ошибка 5. Делать внутренние инструменты внешнему эксперту
...
#### Ошибка 6. Пытаться пушить сразу всех
...
#### Ошибка 7. Учить пользоваться ИИ на примере переноса фронта
...
### Ошибка 8. Считать не те метрики
...
### Ошибка 10. Забивать на лучшие практики разработки
...
### Ошибка 11. Использовать голый grep
